...
class EntityInfoModel {
  public:
	...
	[[nodiscard]] bool showsTabs() const { return showsTabsFlag; }

	/// Get active tab ID
	[[nodiscard]] const std::string& activeTab() const { return activeTabId; }
  ...
  private:
	...
	std::string activeTabId = "status";
	bool showsTabsFlag = false;
	bool visible = false;
	bool tabChangeRequested = false;
