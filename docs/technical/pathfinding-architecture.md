...
**P3 — Regional layer.** Components from mesh faces, perimeter connectivity, traversal-class IDs, reachability API, RRA* heuristic. AI goal validity gets cheap; failed-path costs vanish.
