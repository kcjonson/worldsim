...
### Organic Terrain Geometry (terrain polygons)
**Spec/Documentation:** `/docs/technical/organic-terrain/terrain-polygons-architecture.md`
**Dependencies:** none
**Status:** in progress (Specboard WOR-455)
...
- [x] `TerrainDistanceField` bake, CPU side (WOR-465; GPU upload moves to the shader task)
