...
static Foundation::LogLevel ConvertLogLevel(LogLevel level) {
	switch (level) {
		case LogLevel::Debug: return Foundation::LogLevel::Debug;
		case LogLevel::Info: return Foundation::LogLevel::Info;
		case LogLevel::Warning: return Foundation::LogLevel::Warning;
		case LogLevel::Error: return Foundation::LogLevel::Error;
		default: return Foundation::LogLevel::Info;
	}
}
...
static Foundation::LogCategory ConvertLogCategory(LogCategory category) {
	switch (category) {
		case LogCategory::Renderer: return Foundation::LogCategory::Renderer;
		case LogCategory::Physics: return Foundation::LogCategory::Physics;
		case LogCategory::Audio: return Foundation::LogCategory::Audio;
		case LogCategory::Network: return Foundation::LogCategory::Network;
		case LogCategory::Game: return Foundation::LogCategory::Game;
		case LogCategory::World: return Foundation::LogCategory::World;
		case LogCategory::UI: return Foundation::LogCategory::UI;
		case LogCategory::Engine: return Foundation::LogCategory::Engine;
		case LogCategory::Foundation: return Foundation::LogCategory::Foundation;
		default: return Foundation::LogCategory::Foundation;
	}
}
